...
function Locale()
{
 ...
 //fill in location prototype
   ...
   location[7].description = "You have caught a guy beating his wife in an apartment. There are handcuffs on the ground.";
...
//Item Prototype  
   ...
   location[3].item = new Item();
   location[3].item.id= 0;
   location[3].item.name = "drugs";
   location[3].item.description = "You took the drugs and arrested the man."; 
...
{
	var message= "You are a police officer in the middle of New York City.  You work night hours so this is when the most robberies and crimes occur.  Your objective is to catch as many robbers and criminals as possible throughout the night.  You are currently at your precinct awaiting to catch criminals throughout the night.  Your objective for today is to bring back 4 pieces of evidence from 4 crimes.  Once thats done you can go home.";
